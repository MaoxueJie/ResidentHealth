		...
		try{
			...
			if (psys!= null && psys.size()>0)
			{
				...
				if (gad7!=null)
				{
					...
					{
						//可能有轻微焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在轻微焦虑症，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
					}else if (gad7.getGad7Score()>=10 && gad7.getGad7Score()<=13)
					{
						//可能有中度焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中度焦虑症，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
					}else if (gad7.getGad7Score()>=14 && gad7.getGad7Score()<=18)
					{
						//可能有中重度焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中重度焦虑症，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
				...
				if (phq9!=null)
				{
					...
					{
						//轻度抑郁
						psychologicalReport += "<p>经初步测试，结果提示您可能存在轻度抑郁，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
					}else if (phq9.getPhq9Score()>=10 && phq9.getPhq9Score()<=14)
					{
						//中度抑郁
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中度抑郁，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
					}else if (phq9.getPhq9Score()>=15 && phq9.getPhq9Score()<=19)
					{
						//中重度抑郁
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中重度抑郁，您可以通过相关链接了解更多的相关信息，并进行适当的自我调节，若有疑问或需要更进一步的帮助，请与您的签约医生或社区护士联系。</p>";
