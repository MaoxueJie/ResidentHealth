		...
		try{
			...
			if (psys!= null && psys.size()>0)
			{
				...
				if (gad7!=null)
				{
					...
					{
						//可能有轻微焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在轻微焦虑情绪。</p>";
						...
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">焦虑情绪调整方法</a></p>";
					}else if (gad7.getGad7Score()>=10 && gad7.getGad7Score()<=13)
					{
						//可能有中度焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中度焦虑情绪。</p>";
						psychologicalReport += "<p>对于此，您不用过分紧张，即便是正常人群也可能存在焦虑情绪。焦虑是对亲人或自己生命安全、前途命运等的过度担心而产生的一种烦躁情绪。其中含有着急、挂念、忧愁、紧张、恐慌、不安等成分。它与危急情况和难以预测、难以应付的事件有关。事过境迁、焦虑就可能解除。有人并无客观原因而长期处于焦虑状态，常常无缘无故害怕大祸临头，担心患有不可救药的严重疾病，以致出现坐卧不宁、惶惶不安等症状。这种异常焦虑，才称之为焦虑症。</p>";
						psychologicalReport += "<p>首先您自省一下，是否有一些引发您产生焦虑情绪的原因，如慢性病的影响，不良的生活事件，个性特点等，针对引起焦虑的原因，可以进行针对性的干预。平日您可以做一些放松训练。</p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">焦虑情绪调整方法</a></p>";
						psychologicalReport += "<p如果不能缓解，可求助专业的心理医生进行心理治疗，临床心理医师通过言语或非言语沟通，建立起良好的医患关系，应用有关心理学和医学的专业知识，引导和帮助患者改变行为习惯、认知应对方式等。音乐治疗，舞动治疗，陶艺治疗，美术治疗，阅读治疗等等都可以有效缓解焦虑情绪。</p>";
					}else if (gad7.getGad7Score()>=14 && gad7.getGad7Score()<=18)
					{
						//可能有中重度焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在中重度焦虑情绪。</p>";
						psychologicalReport += "<p>对于此，您不用过分紧张，即便是正常人群也可能存在一定的焦虑情绪。焦虑是对亲人或自己生命安全、前途命运等的过度担心而产生的一种烦躁情绪。其中含有着急、挂念、忧愁、紧张、恐慌、不安等成分。它与危急情况和难以预测、难以应付的事件有关。事过境迁、焦虑就可能解除。有人并无客观原因而长期处于焦虑状态，常常无缘无故害怕大祸临头，担心患有不可救药的严重疾病，以致出现坐卧不宁、惶惶不安等症状。这种异常焦虑，才称之为焦虑症。首先您自省一下，是否有一些引发您产生焦虑情绪的原因，如慢性病的影响，不良的生活事件，个性特点等，针对引起焦虑的原因，可以进行有针对性的区分。</p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">焦虑情绪调整方法</a></p>";
					}else if (gad7.getGad7Score()>=19)
					{
						//可能有重度焦虑症
						psychologicalReport += "<p>经初步测试，结果提示您可能存在重度焦虑情绪。</p>";
						psychologicalReport += "<p>对于此，您不用过分紧张，即便是正常人群也可能存在焦虑情绪。焦虑是对亲人或自己生命安全、前途命运等的过度担心而产生的一种烦躁情绪。其中含有着急、挂念、忧愁、紧张、恐慌、不安等成分。它与危急情况和难以预测、难以应付的事件有关。事过境迁、焦虑就可能解除。有人并无客观原因而长期处于焦虑状态，常常无缘无故害怕大祸临头，担心患有不可救药的严重疾病，以致出现坐卧不宁、惶惶不安等症状。这种异常焦虑，才称之为焦虑症。首先您自省一下，是否有一些引发您产生焦虑情绪的原因，如慢性病的影响，不良的生活事件，个性特点等，针对引起焦虑的原因，可以进行有针对性的区分。</p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">焦虑情绪调整方法</a></p>";
					}else
					{
				...
				if (phq9!=null)
				{
					...
					{
						//轻度抑郁
						psychologicalReport += "<p>您可能存在轻度抑郁。</p>";
						...
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">抑郁情绪调整方法</a></p>";
					}else if (phq9.getPhq9Score()>=10 && phq9.getPhq9Score()<=14)
					{
						//中度抑郁
						psychologicalReport += "<p>您可能存在中度抑郁。</p>";
						psychologicalReport += "<p>抑郁是一种很常见的情绪反应，特别是现代社会，相对比精神心理，物质生活已经极大丰富，人们也更加关注自己的内心世界，可能内心的满足感与成就感就有所欠缺。当人们遇到工作压力、生活挫折、痛苦境遇、生老病死、天灾人祸等情况时，可能就会产生抑郁情绪。几乎每个人都可能会在某个时候觉得情绪低落。抑郁是指以心境低落为主的精神状态。常伴有各种症状，如焦虑、激越、无价值感、无助感、无望感、自杀观念、意志减退、精神运动迟滞，及各种躯体症状和生理机能障碍（如睡眠障碍）。请结合自身的情况，反思自身的抑郁情绪是否有一定的诱因，如果存在诱因，我们可以通过祛除诱因来达到缓解抑郁情绪的目的。如果诱因无法祛除或生活事件解决不了，尽可能寻求周围的社会支持系统获取帮助。抑郁情绪并不稀奇，也不可怕，可称之为“心灵的感冒”，每个人一生中的不同时段，都可能出现抑郁情绪。轻中度抑郁情绪无需药物治疗，只要及时调整、疏导，改变刺激环境，大多可以缓解。</p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">抑郁情绪调整方法</a></p>";
					...
					{
						//中重度抑郁
						psychologicalReport += "<p>您可能存在中重度抑郁。</p>";
						...
						//重度抑郁
						psychologicalReport += "<p>您可能存在重度抑郁。</p>";
						psychologicalReport += "<p>抑郁是一种很常见的情绪反应，特别是现代社会，相对比精神心理，物质生活已经极大丰富，人们也更加关注自己的内心世界，可能内心的满足感与成就感就有所欠缺。当人们遇到工作压力、生活挫折、痛苦境遇、生老病死、天灾人祸等情况时，可能就会产生抑郁情绪。几乎每个人都可能会在某个时候觉得情绪低落。抑郁是指以心境低落为主的精神状态。常伴有各种症状，如焦虑、激越、无价值感、无助感、无望感、自杀观念、意志减退、精神运动迟滞，及各种躯体症状和生理机能障碍（如睡眠障碍）。请结合自身的情况，反思自身的抑郁情绪是否有一定的诱因，如果存在诱因，我们可以通过祛除诱因来达到缓解抑郁情绪的目的。如果诱因无法祛除或生活事件解决不了，尽可能寻求周围的社会支持系统获取帮助。下面介绍一些关于抑郁症的知识，希望对您有所帮助。</p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/ev0TRzsur1aVvFT7gpgFyw\">情绪管理的常用方法</a></p>";
						psychologicalReport += "<p><a href=\"https://mp.weixin.qq.com/s/GT0IrMpLNuzvg49dpq54fA\">抑郁情绪调整方法</a></p>";
					}else 
					{
						psychologicalReport += "<p>您情绪状态良好，没有抑郁情绪！</p>";
					}
				}
